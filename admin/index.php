...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Crypto &amp; Crypto">
    <meta name="author" content="pixelcave">
    <meta name="robots" content="noindex, nofollow">

    <!-- Open Graph Meta -->
    <meta property="og:title" content="Crypto &amp; Crypto">
    <meta property="og:site_name" content="Codebase">
    <meta property="og:description" content="Crypto &amp; Crypto">
        ...
        <div class="sidebar-content">
          ...
          <div class="content-header content-header-fullrow px-15">
            ...
            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
              ...
              <!-- Logo -->
              <div class="content-header-item">
                  <span class="font-size-xl text-dual-primary-dark">Crypto</span><span class="font-size-xl text-primary">Admin</span>
              </div>
              <!-- END Logo -->
            </div>
            <!-- END Normal Mode -->
              ...
              <div class="sidebar-mini-hidden-b text-center">
                ...
                <ul class="list-inline mt-10">
                  <li class="list-inline-item">
                    <a class="link-effect text-dual-primary-dark font-size-sm font-w600 text-uppercase" href="#">Admin</a>
                  </li>
                  <li class="list-inline-item">
                  </li>
                  <li class="list-inline-item">
          ...
          <div class="bg-black-op-75">
            <div class="content content-top content-full text-center">
              <div class="py-20">
                ...
                <h2 class="h4 font-w400 text-white-op mb-0">Add Cryptos</h2>
              </div>
            </div>
          </div>
        </div>
